...
*
* \brief Definitions for the FRDM-K64F
*/

#ifndef INCLUDE_FRDMK64F_H_
#define INCLUDE_FRDMK64F_H_
...
//#define BOARD_LED_BULB_GPIO GPIOE
//#define BOARD_LED_BULB_GPIO_PORT PORTE
//#define BOARD_LED_BULB_GPIO_PIN 24U

#define BOARD_LED_BULB_GPIO GPIOD
#define BOARD_LED_BULB_GPIO_PORT PORTD
#define BOARD_LED_BULB_GPIO_PIN 7U
