...
*/
typedef SHA2_CTX ed25519_hash_context;
size_t  sha2_context_size = sizeof(SHA2_CTX);
...
ed25519_hash_init(ed25519_hash_context *ctx) 
{
    ...
    if (sha512_impl == NULL)
        return;
    sha512_impl->init(ctx, &sha2_context_size);
}
...
ed25519_hash_update(ed25519_hash_context *ctx, const uint8_t *in, size_t inlen) 
{
    ...
    if (sha512_impl == NULL)
        return;
    sha512_impl->update(ctx, in, inlen);
}
...
ed25519_hash_final(ed25519_hash_context *ctx, uint8_t *hash) 
{
    ...
    if (sha512_impl == NULL)
        return;
    sha512_impl->finalize(ctx, hash, &sha512_digest_size);
}

static void
ed25519_hash(uint8_t *hash, const uint8_t *in, size_t inlen) 
{
    ed25519_hash_context sha2_ctx;
    message_digest_vtable_t* sha512_impl = (message_digest_vtable_t*)crypto_registry_get_vtable(MESSAGE_DIGEST_SHA2_512);
    if (sha512_impl == NULL)
        return;

    sha512_impl->init     (&sha2_ctx, &sha2_context_size);
    sha512_impl->update   (&sha2_ctx, in, inlen);
    sha512_impl->finalize (&sha2_ctx, hash, &sha512_digest_size);
}
