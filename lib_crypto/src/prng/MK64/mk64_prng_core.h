...
*
* \brief MK64 crypto PRNG core definitions.
*/

#ifndef SRC_PRNG_MK64_MK64_PRNG_CORE_H_
#define SRC_PRNG_MK64_MK64_PRNG_CORE_H_
...
/**
* MK64 PRNG Context Structure
*/
typedef struct _mk64_prng_ctx_def
{
	RNG_Type *base;
	uint32_t ref;
} mk64_prng_ctx_t;
...
#endif /* SRC_PRNG_MK64_MK64_PRNG_CORE_H_ */
