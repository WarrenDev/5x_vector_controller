...
*
* \brief crypto AES 256 ECB implementation.
*/
...
#define	IMPL_CIPHER_ID			    BLOCK_CIPHER_ID_AES_256_ECB
...
*/
static
block_cipher_id_t aes_256_ecb_get_cipher_id(void)
{
...
*/
static
size_t aes_256_ecb_get_block_size(void)
{
...
*/
static
size_t aes_256_ecb_get_key_size(void)
{
...
*/
static
size_t aes_256_ecb_get_rounds(block_cipher_ctx_t ctx)
{
...
*/
static
crypto_status_t aes_256_ecb_init(block_cipher_init_t init_param, const uint8_t* key, size_t key_size,
...
*/
static
crypto_status_t aes_256_ecb_set_iv(block_cipher_ctx_t ctx, const uint8_t* iv, size_t iv_size)
{
...
*/
static
crypto_status_t aes_256_ecb_encrypt(block_cipher_ctx_t ctx, const uint8_t* input, size_t input_size, uint8_t* output)
{
    aes_ctx* _ctx = (aes_ctx*)ctx;
...
*/
static
crypto_status_t aes_256_ecb_decrypt(block_cipher_ctx_t ctx, const uint8_t* input, size_t input_size, uint8_t* output)
{
    aes_ctx* _ctx = (aes_ctx*)ctx;
    uint8_t temp_block[AES_BLOCK_SIZE];
...
*/
static
crypto_status_t aes_256_ecb_selftest(block_cipher_ctx_t ctx, uint8_t* scratch, size_t* scratch_size)
{
	return CRYPTO_STATUS_SUCCESS;
}
...
*/
const block_cipher_vtable_t aes_256_ecb_vtable =
{
	aes_256_ecb_get_cipher_id,
	aes_256_ecb_get_block_size,
	aes_256_ecb_get_key_size,
	aes_256_ecb_get_rounds,
	aes_256_ecb_init,
	aes_256_ecb_set_iv,
	aes_256_ecb_encrypt,
	aes_256_ecb_decrypt,
	aes_256_ecb_selftest
};
