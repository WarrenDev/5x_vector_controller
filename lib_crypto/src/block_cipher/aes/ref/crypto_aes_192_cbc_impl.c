...
*
* \brief crypto AES 192 CBC implementation.
*/
...
#define	IMPL_CIPHER_ID			    BLOCK_CIPHER_ID_AES_192_CBC
...
*/
static
block_cipher_id_t aes_192_cbc_get_cipher_id(void)
{
...
*/
static
size_t aes_192_cbc_get_block_size(void)
{
...
*/
static
size_t aes_192_cbc_get_key_size(void)
{
...
*/
static
size_t aes_192_cbc_get_rounds(block_cipher_ctx_t ctx)
{
...
*/
static
crypto_status_t aes_192_cbc_init(block_cipher_init_t init_param, const uint8_t* key, size_t key_size,
...
*/
static
crypto_status_t aes_192_cbc_set_iv(block_cipher_ctx_t ctx, const uint8_t* iv, size_t iv_size)
{
...
*/
static
crypto_status_t aes_192_cbc_encrypt(block_cipher_ctx_t ctx, const uint8_t* input, size_t input_size, uint8_t* output)
{
...
*/
static
crypto_status_t aes_192_cbc_decrypt(block_cipher_ctx_t ctx, const uint8_t* input, size_t input_size, uint8_t* output)
{
...
*/
static
crypto_status_t aes_192_cbc_selftest(block_cipher_ctx_t ctx, uint8_t* scratch, size_t* scratch_size)
{
	return CRYPTO_STATUS_SUCCESS;
}
...
*/
const block_cipher_vtable_t aes_192_cbc_vtable =
{
	aes_192_cbc_get_cipher_id,
	aes_192_cbc_get_block_size,
	aes_192_cbc_get_key_size,
	aes_192_cbc_get_rounds,
	aes_192_cbc_init,
	aes_192_cbc_set_iv,
	aes_192_cbc_encrypt,
	aes_192_cbc_decrypt,
	aes_192_cbc_selftest
};
