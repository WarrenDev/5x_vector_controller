...
*
* \brief crypto AES 192 ECB implementation.
*/
...
#define	IMPL_CIPHER_ID			    BLOCK_CIPHER_ID_AES_192_ECB
#define IMPL_BLOCK_SIZE			    (AES_BLOCK_SIZE * 8)
#define IMPL_KEY_SIZE			    AES_BITSIZE_192
...
*/
static
block_cipher_id_t aes_192_ecb_get_cipher_id(void)
{
...
*/
static
size_t aes_192_ecb_get_block_size(void)
{
...
*/
static
size_t aes_192_ecb_get_key_size(void)
{
...
*/
static
size_t aes_192_ecb_get_rounds(block_cipher_ctx_t ctx)
{
...
*/
static
crypto_status_t aes_192_ecb_init(block_cipher_init_t init_param, const uint8_t* key, size_t key_size,
...
*/
static
crypto_status_t aes_192_ecb_set_iv(block_cipher_ctx_t ctx, const uint8_t* iv, size_t iv_size)
{
...
*/
static
crypto_status_t aes_192_ecb_encrypt(block_cipher_ctx_t ctx, const uint8_t* input, size_t input_size, uint8_t* output)
{
...
*/
static
crypto_status_t aes_192_ecb_decrypt(block_cipher_ctx_t ctx, const uint8_t* input, size_t input_size, uint8_t* output)
{
...
*/
static
crypto_status_t aes_192_ecb_selftest(block_cipher_ctx_t ctx, uint8_t* scratch, size_t* scratch_size)
{
	return CRYPTO_STATUS_SUCCESS;
}
...
*/
const block_cipher_vtable_t aes_192_ecb_vtable =
{
	aes_192_ecb_get_cipher_id,
	aes_192_ecb_get_block_size,
	aes_192_ecb_get_key_size,
	aes_192_ecb_get_rounds,
	aes_192_ecb_init,
	aes_192_ecb_set_iv,
	aes_192_ecb_encrypt,
	aes_192_ecb_decrypt,
	aes_192_ecb_selftest
};
