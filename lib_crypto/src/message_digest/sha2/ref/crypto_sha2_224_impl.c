...
*
* \brief crypto SHA2 224 implementation.
*/
...
#define	IMPL_MESSAGE_DIGEST_ID			    MESSAGE_DIGEST_SHA2_224
#define IMPL_BLOCK_SIZE					    (SHA224_BLOCK_LENGTH * 8)
#define IMPL_DIGEST_SIZE				    SHA224_DIGEST_LENGTH
...
*/
static
message_digest_id_t sha2_224_get_message_digest_id(void)
{
...
*/
static
size_t sha2_224_get_block_size(void)
{
...
*/
static
size_t sha2_224_get_digest_size(void)
{
...
*/
static
crypto_status_t sha2_224_init(message_digest_ctx_t ctx, size_t* ctx_size)
{
...
*/
static
crypto_status_t sha2_224_update(message_digest_ctx_t ctx, const uint8_t* input, size_t input_size)
{

    SHA2_CTX* _ctx = (SHA2_CTX*)ctx;
   
    SHA224Update(_ctx, input, input_size);
	return CRYPTO_STATUS_SUCCESS;
}
...
*/
static
crypto_status_t sha2_224_finalize(message_digest_ctx_t ctx, uint8_t* output, size_t* output_size)
{

    SHA2_CTX* _ctx = (SHA2_CTX*)ctx;
   
    if (*output_size != SHA224_DIGEST_LENGTH)
	{
		*output_size = SHA224_DIGEST_LENGTH;
		return CRYPTO_FAILURE_INSUFFICIENT_SIZE;
	}

	SHA224Final(output, _ctx);
	return CRYPTO_STATUS_SUCCESS;
}
...
*/
static
crypto_status_t sha2_224_selftest(message_digest_ctx_t ctx, uint8_t* scratch, size_t* scratch_size)
{
	return CRYPTO_STATUS_SUCCESS;
}
...
*/
const message_digest_vtable_t sha2_224_vtable =
{
	sha2_224_get_message_digest_id,
	sha2_224_get_block_size,
	sha2_224_get_digest_size,
	sha2_224_init,
	sha2_224_update,
	sha2_224_finalize,
	sha2_224_selftest
