...
*
* \brief crypto SHA2 512 implementation.
*/
...
#define	IMPL_MESSAGE_DIGEST_ID			    MESSAGE_DIGEST_SHA2_512
...
*/
static
message_digest_id_t sha2_512_get_message_digest_id(void)
{
...
*/
static
size_t sha2_512_get_block_size(void)
{
...
*/
static
size_t sha2_512_get_digest_size(void)
{
...
*/
static
crypto_status_t sha2_512_init(message_digest_ctx_t ctx, size_t* ctx_size)
{
...
*/
static
crypto_status_t sha2_512_update(message_digest_ctx_t ctx, const uint8_t* input, size_t input_size)
{

    SHA2_CTX* _ctx = (SHA2_CTX*)ctx;

    SHA512Update(_ctx, input, input_size);
	return CRYPTO_STATUS_SUCCESS;
...
*/
static
crypto_status_t sha2_512_finalize(message_digest_ctx_t ctx, uint8_t* output, size_t* output_size)
{
...
*/
static
crypto_status_t sha2_512_selftest(message_digest_ctx_t ctx, uint8_t* scratch, size_t* scratch_size)
{
	return CRYPTO_STATUS_SUCCESS;
}
...
*/
const message_digest_vtable_t sha2_512_vtable =
{
	sha2_512_get_message_digest_id,
	sha2_512_get_block_size,
	sha2_512_get_digest_size,
	sha2_512_init,
	sha2_512_update,
	sha2_512_finalize,
	sha2_512_selftest
