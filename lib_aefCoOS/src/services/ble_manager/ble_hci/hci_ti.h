...
*******************************************************************************
  ...
  Ported to the GNU C/C++ environment on: Apr 17, 2014
   *      Author: Albert
...
#define HCI_EXT_DELAY_SLEEP							   0xFC1C	// 1.4.0 - Set delay to allow 32KHz clock to stabilize
#define HCI_EXT_RESET_SYSTEM						   0xFC1D   // 1.4.0 - Issue a hard or soft system reset
#define HCI_EXT_OVERLAPPED_PROCESSING				   0xFC1E   // 1.4.0 - Enable or disable overlapped processing (default: disabled)
