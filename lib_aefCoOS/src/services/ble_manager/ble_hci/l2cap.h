...
typedef struct _l2capCmdReject_def l2capCmdReject_t;

// Echo Request format
struct _l2capEchoReq_t
{
  uint8_t *pData; // Optional data field
  uint16_t len;   // Length of data
} __attribute__((__packed__));
typedef struct _l2capEchoReq_t l2capEchoReq_t;

// Echo Response format
struct _l2capEchoRsp_def
{
  uint8_t *pData; // Optional data field -- must be freed by the application
  uint16_t len;   // Length of data
} __attribute__((__packed__));
typedef struct _l2capEchoRsp_def l2capEchoRsp_t;

// Information Request format
struct _l2capInfoReq_def
{
  uint16_t infoType; // Information type
} __attribute__((__packed__));
typedef struct _l2capInfoReq_def l2capInfoReq_t;

// Information Response Data field
union _l2capInfo_def
{
...
typedef struct _l2capParamUpdateReq_def l2capParamUpdateReq_t;

// Connection Parameter Update Response format
struct _l2capParamUpdateRsp_def
{
  uint16_t result; // Result
} __attribute__((__packed__));
typedef struct _l2capParamUpdateRsp_def l2capParamUpdateRsp_t;

// Union of all L2CAP Signaling commands
union _l2capSignalCmd_def
{
  // Requests
...
typedef union _l2capSignalCmd_def l2capSignalCmd_t;
...
struct _l2capSignalEvent_def
{
//  _event_hdr_t hdr; // L2CAP_SIGNAL_EVENT and status
...
typedef struct _l2capSignalEvent_def l2capSignalEvent_t;

// L2CAP packet structure
struct _l2capPacket_def
{
...
typedef struct _l2capPacket_def l2capPacket_t;
...
struct _l2capDataEvent_def
{
//  _event_hdr_t hdr; // L2CAP_DATA_EVENT and status
  uint16_t connHandle;    // connection packet was received on
  l2capPacket_t pkt;    // received packet
} __attribute__((__packed__));
typedef struct _l2capDataEvent_def l2capDataEvent_t;
