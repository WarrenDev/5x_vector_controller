...
*
* \brief  BLE Manager service core definitions.
*
*/

#ifndef SRC_SERVICES_BLE_MANAGER_BLE_MANAGER_SERVICE_CORE_H_
#define SRC_SERVICES_BLE_MANAGER_BLE_MANAGER_SERVICE_CORE_H_
...
#endif /* SRC_SERVICES_BLE_MANAGER_BLE_MANAGER_SERVICE_CORE_H_ */
