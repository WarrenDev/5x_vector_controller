...
*
* \brief  Secure channel service core definitions.
*
*/

#ifndef SRC_SERVICES_SECURE_CHANNEL_SECURE_CHANNEL_SERVICE_CORE_H_
#define SRC_SERVICES_SECURE_CHANNEL_SECURE_CHANNEL_SERVICE_CORE_H_

#include <aef/embedded/service/secure_channel/secure_channel_service.h>
...
#endif /* SRC_SERVICES_SECURE_CHANNEL_SECURE_CHANNEL_SERVICE_CORE_H_ */
