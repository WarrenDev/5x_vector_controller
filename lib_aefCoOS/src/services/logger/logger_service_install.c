...
*
* \brief Implementation of logger system service installation routines.
*
*/
...
/**
* Install the system logger system service.
*
* \param    none
*
...
{
	extern const service_vtable_t system_logger_srv_vtable;
	service_manager_vtable_t* service_manager = system_get_service_manager();

	if ( service_manager == NULL )
		return SERVICE_FAILURE_GENERAL;

	return service_manager->addservice ( &system_logger_srv_vtable );
}
