...
#ifndef SRC_SERVICES_LOGGER_LOGGER_SERVICE_CORE_H_
#define SRC_SERVICES_LOGGER_LOGGER_SERVICE_CORE_H_

#include <aef/embedded/service/logger/logger_service.h>
...
#endif /* SRC_SERVICES_LOGGER_LOGGER_SERVICE_CORE_H_ */
