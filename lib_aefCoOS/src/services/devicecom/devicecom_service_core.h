...
*
* \brief  Device communications service core definitions.
*
*/

#ifndef SRC_SERVICES_DEVICECOM_DEVICECOM_SERVICE_CORE_H_
#define SRC_SERVICES_DEVICECOM_DEVICECOM_SERVICE_CORE_H_

#include <aef/embedded/service/devicecom/devicecom_service.h>
...
#endif /* SRC_SERVICES_DEVICECOM_DEVICECOM_SERVICE_CORE_H_ */
