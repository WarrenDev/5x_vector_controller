...
/**
* certificate_manager_service_core.h
*
* \copyright
...
*
* \brief  Certificate manager service core definitions.
*
*/

#ifndef SRC_SERVICES_CERTIFICATE_MANAGER_CERTIFICATE_MANAGER_SERVICE_CORE_H_
#define SRC_SERVICES_CERTIFICATE_MANAGER_CERTIFICATE_MANAGER_SERVICE_CORE_H_

#include <aef/embedded/service/certificate_manager/certificate_manager_service.h>
...
#endif /* SRC_SERVICES_CERTIFICATE_MANAGER_CERTIFICATE_MANAGER_SERVICE_CORE_H_ */
