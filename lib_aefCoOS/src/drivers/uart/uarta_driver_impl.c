...
*
* \brief UARTA driver implementation.
*/
...
#define DRIVER_NAME			(char*)"IUARTA"
#define UART_BASE			UART0
#define UART_INT			UART0_RX_TX_IRQn
#define UART_CLKSRC 		UART0_CLK_SRC
#define DEFAULT_BAUD_RATE	115200
#define DEFAULT_OPEN_PARMS	0
#define BUFFER_SIZE 		256

static device_driver_id_t	driver_id = DRV_IUART_A;
...
/**
* The UARTA stream interface driver vtable
*/
const stream_driver_vtable_t uarta_vtable =
{
		.getid 		= uart_getid,
