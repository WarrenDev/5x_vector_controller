...
*
* \brief UARTD driver implementation.
*/
...
#define DRIVER_NAME			(char*)"IUARTD"
#define UART_BASE			UART3
#define UART_INT			UART3_RX_TX_IRQn
#define UART_CLKSRC 		UART3_CLK_SRC
#define DEFAULT_BAUD_RATE	9600
#define DEFAULT_OPEN_PARMS	0
#define BUFFER_SIZE 		256

static device_driver_id_t	driver_id = DRV_IUART_D;
...
/**
* The UARTD stream interface driver vtable
*/
const stream_driver_vtable_t uartd_vtable =
{
		.getid 		= uart_getid,
