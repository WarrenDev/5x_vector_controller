...
*
* \brief SPIB driver implementation.
*/
...
#define DRIVER_NAME			(char*)"SPIB"
#define SPI_BASE			SPI1
#define DEFAULT_OPEN_PARMS	(char*)0

static device_driver_id_t	driver_id = DRV_SPI_B;
...
/**
* The SPIB stream interface driver vtable
*/
const stream_driver_vtable_t spib_vtable =
{
		spi_getid,
		spi_getname,
		spi_runlevel,
