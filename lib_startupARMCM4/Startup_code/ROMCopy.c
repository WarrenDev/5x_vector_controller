...
*
* \brief Routine to copy from ROM to RAM.
*/
...
/**
* Routine to flush cache following the ROM to RAM copy
*/
...
/**
* Copy all sections the user marked as ROM into their target RAM addresses.
*
* _S_romp is defined in the linker command file.
* It is a table of RonInfo structures.
